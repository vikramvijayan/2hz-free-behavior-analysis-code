% this function is a modified "makerate"
...
function [bincenters, rate0, rate200, rate500, eb0, eb2, eb5] =  makerate_2(egg, trx, title_string, binning, gate, gate_num, greater, single_choice, plotasgraph)
...
[eb0, eb2, eb5, eb5f0, eb5f2] = calcbinned_2(eggs,trx,v);
[eb0B, eb2B, eb5B, eb5f0B, eb5f2B] = calcbinned_2(eggs,trx,binning);
